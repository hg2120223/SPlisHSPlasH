...
void FluidModelModule(py::module m_sub){
	...
	py::class_<SPH::FluidModel, GenParam::ParameterObject>(m_sub, "FluidModel")
		...
		.def_readwrite_static("MAGNETIC_FORCE_METHOD", &SPH::FluidModel::MAGNETIC_FORCE_METHOD)
		...
		.def("setMagneticForceMethod", overload_cast_<const unsigned int>()(&SPH::FluidModel::setMagneticForceMethod))
		.def("setMagneticForceMethod", overload_cast_<const std::string &>()(&SPH::FluidModel::setMagneticForceMethod))
